...
void testOrdersLists(){
    ...
    // issue deploy order command
    Deploy* deploy = new Deploy(player1, quebec, 25);
    cout << "Quebec army before executed: " << quebec->getNumberOfArmies() << endl;
    cout << "Deploy order is valid: " << deploy->validate() << endl;
    deploy->execute();
    cout<< "Quebec army: " << quebec->getNumberOfArmies() << endl;

    // issue advance order command
    Advance* advance = new Advance(player1, quebec, ontario, 10);
    cout << "Quebec army before executed: " << quebec->getNumberOfArmies() << endl;
    cout << "Ontario army before executed: " << ontario->getNumberOfArmies() << endl;
    cout << "Advance order is valid: " << advance->validate() << endl;
    advance->execute();
    cout<< "Quebec army: " << quebec->getNumberOfArmies() << endl;
    cout<< "Ontario army: " << ontario->getNumberOfArmies() << endl;

    // issue bomb order command
    Bomb* bomb = new Bomb(player1, alberta);
    cout << "Alberta army before executed: " << alberta->getNumberOfArmies() << endl;
    cout << "Bomb order is valid: " << bomb->validate() << endl;
    bomb->execute();
    cout<< "Alberta army: " << alberta->getNumberOfArmies() << endl;

    // issue blockade order command
    Blockade* blockade = new Blockade(player1, ontario);
    cout << "Ontario army before executed: " << ontario->getNumberOfArmies() << endl;
    cout << "Blockade order is valid: " << blockade->validate() << endl;
    blockade->execute();
    cout<< "Ontario army: " << ontario->getNumberOfArmies() << endl;

    // issue airlift order command
    Airlift* airlift = new Airlift(player2, alberta, britishColumbia, 10);
    cout << "Alberta army before executed: " << alberta->getNumberOfArmies() << endl;
    cout << "British Columbia army before executed: " << britishColumbia->getNumberOfArmies() << endl;
    cout << "Airlift order is valid: " << airlift->validate() << endl;
    airlift->execute();
    cout<< "Alberta army: " << alberta->getNumberOfArmies() << endl;
    cout<< "British Columbia army: " << britishColumbia->getNumberOfArmies() << endl;

    // issue negotiate order command
    Negotiate* negotiate = new Negotiate(player1, player2);
    cout << "Negotiate order is valid: " << negotiate->validate() << endl;
    negotiate->execute();
}
