...
class Continent
{
    ...
    public:
        ...
        Continent(string inContinentIdentity, int inNumberOfTerritories, vector <Territory*> inTerritories, int inArmybonus); // Saqib 
        ...
        int getArmybonus(); // Saqib

        //Setters
        void setArmyBonus(int inArmyBonus); // Saqib
...
class Map
{
    ...
    public:
        ...
        Territory*getTerritoryByName(string terrName); // Saqib
    ...
    // OPERATOR OVERLOADS
        ...
        int continentControlBonus(Player* player); // Saqib
